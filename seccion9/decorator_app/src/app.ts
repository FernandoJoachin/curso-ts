...
personForm?.addEventListener('submit', event => {
    ...
    const emailElem: HTMLInputElement = document.getElementById('email') as HTMLInputElement;
    const passwordElem: HTMLInputElement = document.getElementById('password') as HTMLInputElement;
